...
const Experience = () => {
  return (
    <div id="skill" className="bg-gradient-to-b from-black to-gray-800 w-full">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full py-10 text-white">
        <div>
